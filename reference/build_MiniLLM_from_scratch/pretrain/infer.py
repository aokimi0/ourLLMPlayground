...
args.config_path = os.path.join(args.dir_path, 'MiniLLM-0.2B-Base/bert4torch_config.json')
args.model_path = '../ckpt/pretrain/MiniLLM-0.2B-Base/final_3.1822/model.pt'
