...
deepspeed --num_gpus=1 --master_port $(shuf -n 1 -i 10000-65535) pretrain.py  --deepspeed ../config/pretrain/MiniLLM-0.2B-Base/ds_config.json
"""
...
# ==============================参数区==============================
# 训练使用到的参数，可加载不同的文件
args = YamlConfig('../config/pretrain/MiniLLM-0.2B-Base/pretrain_args.yaml')
